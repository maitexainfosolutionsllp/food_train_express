...
class ShopDishesDetailsScreen extends StatefulWidget {
  final String title;
  final bool nomenu;
  ShopDishesDetailsScreen({Key key, this.title, this.nomenu}) : super(key: key);
  @override
  _ShopDishesDetailsScreenState createState() => _ShopDishesDetailsScreenState();
}

class _ShopDishesDetailsScreenState extends State<ShopDishesDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  _tapAddToCart() async
  {
    ...
    var res = await Api().authData(data, '/shop/shop-order-food');
