...
class _DeliveryScreenState extends State<DeliveryScreen>
  ...
  _pressContinueButton(){
    ...
    if (stage == 1) {
      ...
      print("Compartment: ${editControllerAddress1.text}, Seat No: ${editControllerCity
  ...
  _body(List<Widget> list){
      ...
      list.add(Container(
        ...
        child: IInputField2(hint : "Compartment",                      // "Address 1"
      ...
      list.add(Container(
          margin: const EdgeInsets.fromLTRB(20, 0, 20, 15),
          child: IInputField2(hint : "Seat No",                      // City
