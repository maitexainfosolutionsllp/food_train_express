...
import 'package:fooddelivery/delivery_boy/config/googleApi.dart';
import 'package:fooddelivery/delivery_boy/model/geolocator.dart';
import 'package:fooddelivery/delivery_boy/model/order.dart';
import 'package:fooddelivery/delivery_boy/ui/widgets/iboxCircle.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  _initCameraPosition(Order item, LatLng coord) async{
    ...
    print("latLng_1 = $latLng_1");
    print("latLng_2 = $latLng_2");
    LatLngBounds bound;
