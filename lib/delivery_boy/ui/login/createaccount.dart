...
class DeliveryCreateAccountScreen extends StatefulWidget {
  @override
  _DeliveryCreateAccountScreenState createState() => _DeliveryCreateAccountScreenState();
}
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text("Delivery Boy - Sign Up",                        // "Create an Account!"
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                    ...
                    child:
                    IInputField2(
                      hint: "Phone number",            // "E-mail address",
                      icon: Icons.phone,
                      colorDefaultText: theme.colorPrimary,
                      colorBackground: theme.colorBackgroundDialog,
